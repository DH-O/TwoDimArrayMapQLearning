...
if __name__ == '__main__':
    ...
    path = f'./results_DQN/results_DQN_{now_day}_{X_SIZE, Y_SIZE}_{GAMMA}_NE_{NUM_EPISODES}_TSL_{TIME_LIMIT}_{GoalCon}_{TARGET_UPDATE}_{RANDOM_ACTION_PROB}_{RANDOM_GOAL}_{RM_SIZE}/result_{now}'
